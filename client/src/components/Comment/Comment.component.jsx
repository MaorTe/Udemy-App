         ...
         <div>
            {!editable && (
               <S.IconsContainer>
                  ...
                  <S.DeleteIcon className="far fa-trash-alt" onClick={handleDelete}></S.DeleteIcon>
               </S.IconsContainer>
            )}
            {editable && (
               <S.IconsContainer>
                  <S.SaveIcon className="fas fa-check" onClick={handleEdit}></S.SaveIcon>
                  <S.CancelIcon
   ...
   return (
      <S.CommentWrapper>
         ...
         <S.CommentText>
            ...
            {!editable && <p title={comment.content}>{truncate(comment.content, 120)}</p>}
            {editable && (
               <S.Commentbody
                  cols="30"
                  rows="2"
